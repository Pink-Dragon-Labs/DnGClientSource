...
const int maxCOV = 100;
const int maxScaledLine = 4096;
...
//	protected:
	...
	HBITMAP CreateHBitmap ( double shading, COLORREF *pSkipColor );
	HBITMAP CreateHBitmap ( double shading, Ratio &scaleX, Ratio &scaleY, COLORREF *skipColor );
