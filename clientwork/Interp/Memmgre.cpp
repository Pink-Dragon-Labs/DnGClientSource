...
const	int rows = 80;
const 	int cols = 100;
const 	int indexXPixels = 3;
const 	int indexYPixels = 2;
const 	int arrayPixels = rows*cols;
size_t	BMSize;
size_t	memPerIndex;
...
MemoryMgr::ShowText(int from,int to)
{
	...
	for (maxUsedHandle=maxDescriptors;RESERVEDHANDLES < maxUsedHandle;--maxUsedHandle)	{
